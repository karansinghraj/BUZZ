...
function GetAccountDetail(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield services.GetEducationAccount(req);
        res.json(response);
    });
}
...
function AddEmployee(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield services.AddEdEmployee(req, model);
        res.json(response);
    });
}
...
function AddCompany(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const model = req.body;
        const response = yield services.AddEdCompany(req, model);
        res.json(response);
    });
}
